...
i'm listening live and they replay it on today's show so if you want to hear just check that also http://www.mixcloud.com/thedanfrank/daltons-dance-grooves-trap-mix/edit/ gogogogo er....drop the /edit/
...
Metric
	Alexis Record
	Annie Record (Aug 25–Mar 26)
	Total messages
	~10,000
	18,236+
	Dan:Other ratio
	1.64:1
	1.23:1 → 2.12:1 (collapsing)
	Dan crisis statements
	2
	12
	Dan verbal abuse markers
	5
	74+ ("fuck you" alone)
	Love-to-request ratio (received)
	Not applicable
	187:4
	"Fell asleep" alibis
	0 documented
	24 documented
	Controlled void / ghosting
	0 documented
	36.5hr max documented
	False exit declarations
	0 (1 real exit, held)
	127, 100% re-engagement
	Humor as primary mode
	Dominant
	Marginal/punctuation
	Procurement-function affection
	None documented
	Structurally dominant
	Drug supply as relationship structure
	Background/context
	Primary retention mechanism
	Suicidal statement responses
	N/A (none sent)
	Bar name, laundry, 12-hr silence
	Annie/Alexis self-aware statements
	None needed
	46 documented (Annie)
	Mutual intellectual engagement
	High, documented
	Rare, mostly in memory
	Care checks per month (from her)
	Organic/regular
	Once per 55 days (Annie)

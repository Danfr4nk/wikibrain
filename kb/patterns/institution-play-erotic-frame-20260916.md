+++
id         = "pat:institution-play-erotic-frame-20260916"
layer      = 4
type       = "pattern"
...
created    = "2026-09-16"
falsifiers = [
  "A second full institution-play specimen where the paperwork is dropped mid-scene with no consequence — the machinery was decoration, not binding.",
  "Dan explicitly disavows a documented rule inside its own fiction frame ('that was just talk') and the frame continues unchanged — then legislation doesn't bind.",
  "The corpus shows him running equivalent erotic scenes with zero institutional apparatus — then institution-play is a mood of one night, not his commitment technology."
]
counterexamples = [
...
Looked for a prior full-specimen institution in the record: none found at the
charter/dissolution/severance completeness of the GOONER CLUB. Near-misses —
the tag-action registry (2026-09-15) has written law and rotation ledgers but
no fiction frame and no binding stakes; the wager inside the GOONER CLUB

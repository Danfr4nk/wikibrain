+++
id         = "pat:four-component-erotic-circuit-20260915"
layer      = 4
type       = "pattern"
...
falsifiers = [
  ...
  "The without-her-in-frame test he named: the amplifier holds with no Annie in the frame — then worship is not load-bearing.",
  "Her visible arousal by another man registers flat while the sub/taboo components alone carry the heat — then the illusion-break is not the charge.",
]
alternatives = [
  "Novelty-driven wrongness: the charge is transgression-novelty, and worship is one convenient source of the sacred, not the only one.",
